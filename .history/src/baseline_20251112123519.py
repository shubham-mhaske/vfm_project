...
class BaselineResNet50(nn.Module):
    def __init__(self,
        ...
        # Load model from Hugging Face Transformers
        # ignore_mismatched_sizes=True allows us to load a pretrained model with a new classifier head
        ...
        if freeze_backbone:
            ...
            # Unfreeze the new conv layer if it was created
            if in_channels != 3:
        ...
        # Unfreeze the original fc layer before replacing it to ensure gradients can flow
        if freeze_backbone:
